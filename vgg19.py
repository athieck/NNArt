...
def VGG19(include_top=True, weights='imagenet',
          input_tensor=None, filterSize=(2,2), strideSize=(2,2), poolType="max"):
    ...
    if poolType == "avg":
        x = AveragePooling2D(filterSize, strides=strideSize, name='block1_pool')(x)
    else:
        x = MaxPooling2D(filterSize, strides=strideSize, name='block1_pool')(x)
    ...
    if poolType == "avg":
        x = AveragePooling2D(filterSize, strides=strideSize, name='block2_pool')(x)
    else:
        x = MaxPooling2D(filterSize, strides=strideSize, name='block2_pool')(x)
    ...
    if poolType == "avg":
        x = AveragePooling2D(filterSize, strides=strideSize, name='block3_pool')(x)
    else:
        x = MaxPooling2D(filterSize, strides=strideSize, name='block3_pool')(x)
    ...
    if poolType == "avg":
        x = AveragePooling2D(filterSize, strides=strideSize, name='block4_pool')(x)
    else:
        x = MaxPooling2D(filterSize, strides=strideSize, name='block4_pool')(x)
    ...
    if poolType == "avg":
        x = AveragePooling2D(filterSize, strides=strideSize, name='block5_pool')(x)
    else:
        x = MaxPooling2D(filterSize, strides=strideSize, name='block5_pool')(x)
